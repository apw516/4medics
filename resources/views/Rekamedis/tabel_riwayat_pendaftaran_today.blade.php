<div class="card">
    ...
    <div class="card-body">
        <table id="tabel_riwayat_today" class="table table-sm table-bordered table-hover">
            <thead>
                <th>Tanggal Masuk</th>
                <th>Kunjungan Ke</th>
                <th>No RM</th>
                ...
                @foreach ($riwayat as $r)
                    <tr>
                        ...
                        <td><button class="btn btn-warning btn-sm editkunjunganbtn"
                            ...
                            <button kode_kunjungan="{{ $r->kode_kunjungan }}" class="btn btn-info btn-sm pilihpasien"
                                data-toggle="modal" data-target="#modalresume"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
                        class="bi bi-x-square mr-2"></i> Tutup</button>
                <button type="button" class="btn btn-primary" onclick="simpaneditkunjungan()"><i
                        class="bi bi-save2 mr-2"></i> Simpan Edit</button>
            </div>
        </div>
    </div>
</div>
