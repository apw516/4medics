...
<script>
    ...
    $(".pilihobat").on('click', function(event) {
        ...
        $(wrapper).append(
            '<div class="form-row text-xs"><div class="form-group col-md-4"><label for="">Nama Obat</label><input readonly type="" class="form-control form-control-sm text-xs edit_field" id="" name="namaobat" value="' +
         nama +
         '"><input hidden readonly type="" class="form-control form-control-sm" id="" name="idobat" value="' +
         idtarif +
         '"><input hidden readonly type="" class="form-control form-control-sm" id="" name="iddetail" value="0"></div><div class="form-group col-md-1"><label for="inputPassword4">Sediaan</label><input readonly type="" class="form-control form-control-sm" id="" name="sediaan" value="' +
         sediaan +
