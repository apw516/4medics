<form class="formaddukp">
    <div class="form-group">
        <label for="exampleInputEmail1">Nama UKP / KEFARMASIAN / LABORATORIUM</label>
        <input type="text" class="form-control form-control-sm" id="namaukp" name="namaukp"
            aria-describedby="emailHelp" placeholder="Masukan Nama UKP / KEFARMASIAN / LABORATORIUM ...">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">Nama Display</label>
        <input type="text" class="form-control form-control-sm" id="namadisplay" name="namadisplay">
    </div>
</form>
<script>
